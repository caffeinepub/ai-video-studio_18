...
export class Backend implements backendInterface {
    ...
    async addJobComment(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addJobComment(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createJob(arg0: VideoJobInput): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async filterByMode(arg0: string): Promise<Array<VideoJob>> {
        if (this.processError) {
            try {
                const result = await this.actor.filterByMode(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async filterByVoiceGender(arg0: string): Promise<Array<VideoJob>> {
        if (this.processError) {
            try {
                const result = await this.actor.filterByVoiceGender(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getImageAsset(arg0: string): Promise<ExternalBlob | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getImageAsset(arg0);
    ...
    async getJobComments(arg0: bigint): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getJobComments(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMusicAsset(arg0: string): Promise<ExternalBlob | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getMusicAsset(arg0);
                return from_candid_opt_n8(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async jobsCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.jobsCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async transformLanguage(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.transformLanguage();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadImageAsset(arg0: string, arg1: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadImageAsset(arg0, await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadMusicAsset(arg0: string, arg1: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadMusicAsset(arg0, await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
